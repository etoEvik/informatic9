# Задача:
# Відомий американський письменник Рей Бредбері має роман «451 градус за Фаренгейтом». Напишіть програму, яка визначає, якій температурі за шкалою Цельсія відповідає вказане значення за шкалою Фаренгейта.
# Використовуйте формулу для перекладу:
# C=5/9(F−32)
# Формат вхідних даних 
# На вхід до програми подається дійсне число градусів за шкалою Фаренгейта. 
# Формат вихідних даних 
# Програма має вивести кількість градусів за шкалою Цельсія.

# Примітка: дійсне (дробове) число ви отримуєте за допомогою методу float
